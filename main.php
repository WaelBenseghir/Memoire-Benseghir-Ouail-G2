    ...
    <main class="main">
        ...
        <section class="hero">
            ...
            <div class="flex-group-hero">
                <div class="hero__flex">
                    ...
                    <a href="plant-base.php" class="explore">Explore</a>
                </div>
                <a href="weather.php" class="btn-home cta-btn">Check Weather</a>
            </div>
        </section>
        ...
        <section class="first-section container">
            <div class="grid-group">
                ...
                <a href="diagnose.php" class="cta-btn btnn">Check Your Plants</a>
            </div>
        </section>
        ...
        <section class="second-section container">
            <nav class="section__nav">
                <ul class="section__list">
                    <li class="section__item"><button class="list__button" data-target="vegetables">Fruit and
                            vegetables</button></li>
                    <li class="section__item"><button class="list__button" data-target="flowers">Flowering
                            Plants</button></li>
                    <li class="section__item"><button class="list__button" data-target="herbs">Herbs</button></li>
                    <li class="section__item last__item"><a href="plant-base.php" class="list__button">View More</a>
                    </li>
                </ul>
            </nav>

            <div class="flex-group" id="vegetables">
                <div class="card flex-item-1 plant-card" data-category="Fruits & Vegetables"
                    style="background-image: url(uploads/onion.webp);">
                    <h2 class="text">Onion</h2>
                </div>

                <div class="card flex-item-2 plant-card" data-category="Fruits & Vegetables"
                    style="background-image: url(uploads/tomato.webp);">
                    <h2 class="text">Tomato</h2>
                </div>

                <div class="card flex-item-3 plant-card" data-category="Fruits & Vegetables"
                    style="background-image: url(uploads/carrots.webp);">
                    <h2 class="text">Carrots</h2>
                </div>
            </div>

            <div class="flex-group" id="flowers">
                <div class="card flex-item-2 plant-card" data-category="flowers" style="background-image: url(uploads/Orchid.webp);">
                    <h2 class="text">Orchid</h2>
                </div>

                <div class="card flex-item-1 plant-card" data-category="flowers" style="background-image: url(uploads/jasmin.webp);">
                    <h2 class="text">Jasmin</h2>
                </div>

                <div class="card flex-item-3 plant-card" data-category="flowers" style="background-image: url(uploads/peony.webp);">
                    <h2 class="text">Peony</h2>
                </div>
            </div>

            <div class="flex-group" id="herbs">
                <div class="card flex-item-3 plant-card" data-category="herbs" style="background-image: url(uploads/oregano.webp);">
                    <h2 class="text">Oregano</h2>
                </div>

                <div class="card flex-item-1 plant-card" data-category="herbs" style="background-image: url(uploads/basil.webp);">
                    <h2 class="text">Basil</h2>
                </div>

                <div class="card flex-item-2 plant-card" data-category="herbs" style="background-image: url(uploads/cilantro.webp);">
                    <h2 class="text">Cilantro</h2>
                </div>
            </div>
        </section>
        ...
        <section class="third-section container">
            ...
            <div class="grid-group-1">
                <a href="diagnose.php" class="card-1">
                    <div class="card-1 card">
                        <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="800" height="800"
                            viewBox="0 0 24 24">
                ...
                <a href="weather.php" class="card-2">
                    <div class="card-2 card">
                        ...
                        <div class="txt">
                            <h3>Weather</h3>
                            <p class="txt__desc">Stay prepared with real-time weather updates and forecasts tailored to
                                your
                ...
                <a href="https://www.reddit.com/r/farming/" target="_blank" class="card-3">
                    <div class="card-3 card">
                        ...
                        <div class="txt">
                            <h3>Community</h3>
                            <p class="txt__desc">Join discussions with farmers, share advice, and learn valuable strategies to improve your practices.</p>
                        </div>
                    </div>
                </a>

                <a href="plant-base.php" class="card-4">
                    <div class="card-4 card">
                        ...
                        <div class="txt">
                            <h3>Plant Catalog</h3>
                            <p class="txt__desc">Explore a diverse collection of plants with detailed growing guides, ideal conditions, and care tips for every species.</p>
                        </div>
                    </div>
                </a>
