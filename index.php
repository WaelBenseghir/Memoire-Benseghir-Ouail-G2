...
if (isset($_POST['signIn'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $_SESSION['role'] = ($row['email'] === 'admin@gmail.com') ? 'admin' : 'user';
...
<body>
    <div class="content">
        <main class="main">
            ...
            <div class="container signInForm" style="<?php echo $showSignUpForm ? 'display: none;' : 'display: block;'; ?>">
                <h1>Welcome back!</h1>
                <p class="title__desc">Enter your details to access your account.</p>
                <a href="main.php" class="main-page">Click to go to main page</a>
            ...
            <div class="container signUpForm" style="<?php echo $showSignUpForm ? 'display: block;' : 'display: none;'; ?>">
                ...
                <form method="post" action="">
                    ...
                    <div class="error-message signUpError">
                        <?php if (isset($signUpError)) echo $signUpError; ?>
                    </div>
